...
class Question1QiitaListFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar?.setTitle(R.string.article_view_question1)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_qiita_list_question1, container, false)
    }
    ...
    private fun setupRecyclerView() {
        view?.let {view ->
            ...
            val adapter = Question1QiitaListViewAdapter(qiitaArticles)
            recyclerView.adapter = adapter
            val decorator = DividerItemDecoration(context, layoutManager.orientation)
            recyclerView.addItemDecoration(decorator)

            adapter.setOnItemClickListener(object: Question1QiitaListViewAdapter.OnItemClickListener{
    ...
    companion object {
        ...
        fun newInstance(response: ArrayList<QiitaArticleResponse>): Question1QiitaListFragment {
            val fragment = Question1QiitaListFragment()
            val args = Bundle()
